...
import bmartin127.advancedperipheralsremastered.lib.peripherals.BasePeripheral;
...
public abstract class PeripheralBlockEntity<T extends BasePeripheral<?>> extends LockableContainerBlockEntity implements WorldlyContainer, MenuProvider, de.srendi.advancedperipherals.lib.peripherals.IPeripheralTileEntity {
    // TODO: move inventory logic to another tile entity!
    private static final String PERIPHERAL_SETTINGS_KEY = "peripheralSettings";
    protected NbtCompound peripheralSettings;
    ...
    public PeripheralBlockEntity(BlockEntityType<?> tileEntityTypeIn, BlockPos pos, BlockState state) {
        ...
        if (this instanceof de.srendi.advancedperipherals.common.blocks.base.IInventoryBlock<?> inventoryBlock) {
